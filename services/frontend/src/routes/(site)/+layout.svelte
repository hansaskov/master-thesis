<script lang="ts">
  ...
  <div class="flex min-h-screen w-full flex-col bg-background/40 text-foreground">
    <header class="sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-background px-4 sm:px-6">
